...
--
-- Hôte : localhost:3306
-- Généré le :  lun. 03 fév. 2020 à 12:51
...
CREATE TABLE `circuit` (
  `CIRNUM` smallint NOT NULL,
  `PAYNUM` int NOT NULL,
  `CIRNOM` varchar(30) CHARACTER SET latin1 COLLATE latin1_general_cs DEFAULT NULL,
  `CIRLONGUEUR` int DEFAULT NULL,
  `CIRNBSPECTATEURS` bigint DEFAULT NULL,
...
CREATE TABLE `course` (
  `GPNUM` smallint NOT NULL,
  `PILNUM` smallint NOT NULL,
...
CREATE TABLE `ecurie` (
  `ECUNUM` smallint NOT NULL,
  `FPNUM` smallint DEFAULT NULL,
  `ECUNOM` varchar(30) DEFAULT NULL,
  `ECUNOMDIR` varchar(30) DEFAULT NULL,
  `ECUADRSIEGE` varchar(100) DEFAULT NULL,
  `ECUPOINTS` int DEFAULT NULL,
  `PAYNUM` int DEFAULT NULL,
...
(9, NULL, 'Super Aguri F1', 'Aguri Suzuki', 'Super Aguri F1 Team, Leafield Tech. Centre Langley, Witney, Oxfordshire OX29 9EF, England ', NULL, 6, 'super_aguri.gif'),
...
CREATE TABLE `fourn_pneu` (
  `FPNUM` smallint NOT NULL,
  `PAYNUM` int NOT NULL,
...
--
-- Déchargement des données de la table `fourn_pneu`
--
...
CREATE TABLE `login` (
  ...
  `PASSWD` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
...
CREATE TABLE `points` (
  `PTPLACE` bigint NOT NULL,
  `PTNBPOINTSPLACE` bigint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Déchargement des données de la table `sponsorise`
--
...
CREATE TABLE `voiture` (
  `VOINUM` smallint NOT NULL,
  `ECUNUM` smallint NOT NULL,
  `TYPNUM` smallint DEFAULT NULL,
...
--
ALTER TABLE `circuit`
  MODIFY `CIRNUM` smallint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT pour la table `ecurie`
--
ALTER TABLE `ecurie`
  MODIFY `ECUNUM` smallint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT pour la table `fourn_pneu`
--
ALTER TABLE `fourn_pneu`
  MODIFY `FPNUM` smallint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `grandprix`
--
ALTER TABLE `grandprix`
  MODIFY `GPNUM` smallint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT pour la table `pays`
--
ALTER TABLE `pays`
  MODIFY `PAYNUM` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT pour la table `pilote`
--
ALTER TABLE `pilote`
  MODIFY `PILNUM` smallint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT pour la table `sponsor`
--
ALTER TABLE `sponsor`
  MODIFY `SPONUM` smallint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT pour la table `type_voiture`
--
ALTER TABLE `type_voiture`
  MODIFY `TYPNUM` smallint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `voiture`
--
ALTER TABLE `voiture`
  MODIFY `VOINUM` smallint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `circuit`
  ADD CONSTRAINT `FK_CIRCUIT_EST_DANS_PAYS` FOREIGN KEY (`PAYNUM`) REFERENCES `pays` (`PAYNUM`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `course`
--
ALTER TABLE `course`
  ADD CONSTRAINT `FK_COURSE_COURSE2_PILOTE` FOREIGN KEY (`PILNUM`) REFERENCES `pilote` (`PILNUM`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `FK_COURSE_COURSE_GRANDPRI` FOREIGN KEY (`GPNUM`) REFERENCES `grandprix` (`GPNUM`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `ecurie`
--
ALTER TABLE `ecurie`
  ADD CONSTRAINT `ecurie_fk` FOREIGN KEY (`PAYNUM`) REFERENCES `pays` (`PAYNUM`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `FK_ECURIE_FOURNIT_FOURNISS` FOREIGN KEY (`FPNUM`) REFERENCES `fourn_pneu` (`FPNUM`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `essais`
--
ALTER TABLE `essais`
  ADD CONSTRAINT `FK_ESSAIS_ESSAIS2_PILOTE` FOREIGN KEY (`PILNUM`) REFERENCES `pilote` (`PILNUM`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `FK_ESSAIS_ESSAIS_GRANDPRI` FOREIGN KEY (`GPNUM`) REFERENCES `grandprix` (`GPNUM`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `finance`
--
ALTER TABLE `finance`
  ADD CONSTRAINT `FK_FINANCE_FINANCE2_SPONSOR` FOREIGN KEY (`SPONUM`) REFERENCES `sponsor` (`SPONUM`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `FK_FINANCE_FINANCE_ECURIE` FOREIGN KEY (`ECUNUM`) REFERENCES `ecurie` (`ECUNUM`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `fourn_pneu`
--
ALTER TABLE `fourn_pneu`
  ADD CONSTRAINT `FK_FOURNISS_NATIONALI_PAYS` FOREIGN KEY (`PAYNUM`) REFERENCES `pays` (`PAYNUM`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `grandprix`
--
ALTER TABLE `grandprix`
  ADD CONSTRAINT `FK_GRANDPRI_SE_DEROUL_CIRCUIT` FOREIGN KEY (`CIRNUM`) REFERENCES `circuit` (`CIRNUM`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `photo`
--
ALTER TABLE `photo`
  ADD CONSTRAINT `FK_PHOTO_POSSEDE_VIP` FOREIGN KEY (`PILNUM`) REFERENCES `pilote` (`PILNUM`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `pilote`
--
ALTER TABLE `pilote`
  ADD CONSTRAINT `pilote_ibfk_1` FOREIGN KEY (`PAYNUM`) REFERENCES `pays` (`PAYNUM`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `pilote_ibfk_2` FOREIGN KEY (`ECUNUM`) REFERENCES `ecurie` (`ECUNUM`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `sponsorise`
--
ALTER TABLE `sponsorise`
  ADD CONSTRAINT `FK_SPONSORI_SPONSORIS_PILOTE` FOREIGN KEY (`PILNUM`) REFERENCES `pilote` (`PILNUM`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `FK_SPONSORI_SPONSORIS_SPONSOR` FOREIGN KEY (`SPONUM`) REFERENCES `sponsor` (`SPONUM`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `voiture`
--
ALTER TABLE `voiture`
  ADD CONSTRAINT `voiture_ibfk_1` FOREIGN KEY (`ECUNUM`) REFERENCES `ecurie` (`ECUNUM`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `voiture_ibfk_2` FOREIGN KEY (`TYPNUM`) REFERENCES `type_voiture` (`TYPNUM`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
